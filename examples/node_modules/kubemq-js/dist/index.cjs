...
((kubemq2) => {
  ...
  kubemq2.Subscribe = Subscribe;
  ((Subscribe2) => {
    ((SubscribeType2) => {
      SubscribeType2[SubscribeType2["SubscribeTypeUndefined"] = 0] = "SubscribeTypeUndefined";
      SubscribeType2[SubscribeType2["Events"] = 1] = "Events";
      SubscribeType2[SubscribeType2["EventsStore"] = 2] = "EventsStore";
      SubscribeType2[SubscribeType2["Commands"] = 3] = "Commands";
      SubscribeType2[SubscribeType2["Queries"] = 4] = "Queries";
    })(Subscribe2.SubscribeType || (Subscribe2.SubscribeType = {}));
    ((EventsStoreType2) => {
      EventsStoreType2[EventsStoreType2["EventsStoreTypeUndefined"] = 0] = "EventsStoreTypeUndefined";
      EventsStoreType2[EventsStoreType2["StartNewOnly"] = 1] = "StartNewOnly";
      EventsStoreType2[EventsStoreType2["StartFromFirst"] = 2] = "StartFromFirst";
      EventsStoreType2[EventsStoreType2["StartFromLast"] = 3] = "StartFromLast";
      EventsStoreType2[EventsStoreType2["StartAtSequence"] = 4] = "StartAtSequence";
      EventsStoreType2[EventsStoreType2["StartAtTime"] = 5] = "StartAtTime";
      EventsStoreType2[EventsStoreType2["StartAtTimeDelta"] = 6] = "StartAtTimeDelta";
    })(Subscribe2.EventsStoreType || (Subscribe2.EventsStoreType = {}));
  })(Subscribe = kubemq2.Subscribe || (kubemq2.Subscribe = {}));
  class Request extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
      if (!Array.isArray(data) && typeof data == "object") {
        if ("RequestID" in data && data.RequestID != void 0) {
          this.RequestID = data.RequestID;
        }
        if ("RequestTypeData" in data && data.RequestTypeData != void 0) {
        ...
        if ("ReplyChannel" in data && data.ReplyChannel != void 0) {
          this.ReplyChannel = data.ReplyChannel;
        }
        if ("Timeout" in data && data.Timeout != void 0) {
          this.Timeout = data.Timeout;
        }
        if ("CacheKey" in data && data.CacheKey != void 0) {
          this.CacheKey = data.CacheKey;
        }
        if ("CacheTTL" in data && data.CacheTTL != void 0) {
          this.CacheTTL = data.CacheTTL;
        }
        if ("Span" in data && data.Span != void 0) {
          this.Span = data.Span;
        }
        if ("Tags" in data && data.Tags != void 0) {
          this.Tags = data.Tags;
    ...
    get CacheTTL() {
      return pb_1__namespace.Message.getFieldWithDefault(this, 10, 0);
    }
    set CacheTTL(value) {
    ...
    get Tags() {
      return pb_1__namespace.Message.getField(this, 12);
    }
    set Tags(value) {
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new Request();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.Request = Request;
  ((Request2) => {
    ((RequestType2) => {
      RequestType2[RequestType2["RequestTypeUnknown"] = 0] = "RequestTypeUnknown";
      RequestType2[RequestType2["Command"] = 1] = "Command";
      RequestType2[RequestType2["Query"] = 2] = "Query";
    })(Request2.RequestType || (Request2.RequestType = {}));
  })(Request = kubemq2.Request || (kubemq2.Request = {}));
  class Response extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if ("CacheHit" in data && data.CacheHit != void 0) {
          this.CacheHit = data.CacheHit;
        }
        if ("Timestamp" in data && data.Timestamp != void 0) {
          this.Timestamp = data.Timestamp;
        }
        if ("Executed" in data && data.Executed != void 0) {
    ...
    get Executed() {
      return pb_1__namespace.Message.getFieldWithDefault(this, 8, false);
    }
    set Executed(value) {
      pb_1__namespace.Message.setField(this, 8, value);
    }
    ...
    get Tags() {
      return pb_1__namespace.Message.getField(this, 11);
    }
    set Tags(value) {
      pb_1__namespace.Message.setField(this, 11, value);
    }
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new Response();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.Response = Response;
  class QueueMessage extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
      if (!Array.isArray(data) && typeof data == "object") {
        if ("MessageID" in data && data.MessageID != void 0) {
        ...
        if ("Attributes" in data && data.Attributes != void 0) {
          this.Attributes = data.Attributes;
        }
        if ("Policy" in data && data.Policy != void 0) {
    ...
    get Tags() {
      return pb_1__namespace.Message.getField(this, 6);
    }
    set Tags(value) {
      pb_1__namespace.Message.setField(this, 6, value);
    }
    get Attributes() {
      return pb_1__namespace.Message.getWrapperField(
        this,
    ...
    get Policy() {
      return pb_1__namespace.Message.getWrapperField(this, QueueMessagePolicy, 8);
    }
    set Policy(value) {
      pb_1__namespace.Message.setWrapperField(this, 8, value);
    }
    get has_Policy() {
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new QueueMessage();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.QueueMessage = QueueMessage;
  class QueueMessagesBatchRequest extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(
        this,
      ...
      if (!Array.isArray(data) && typeof data == "object") {
        if ("BatchID" in data && data.BatchID != void 0) {
    ...
    get Messages() {
      return pb_1__namespace.Message.getRepeatedWrapperField(this, QueueMessage, 2);
    }
    set Messages(value) {
    ...
    serialize(w) {
      ...
      if (this.Messages.length)
        writer.writeRepeatedMessage(
          2,
          this.Messages,
          (item) => item.serialize(writer)
        );
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new QueueMessagesBatchRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
          ...
          case 2:
            reader.readMessage(
              message.Messages,
              () => pb_1__namespace.Message.addToRepeatedWrapperField(
                message,
                2,
  ...
  kubemq2.QueueMessagesBatchRequest = QueueMessagesBatchRequest;
  class QueueMessagesBatchResponse extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(
      ...
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if ("Results" in data && data.Results != void 0) {
          this.Results = data.Results;
        }
        if ("HaveErrors" in data && data.HaveErrors != void 0) {
    ...
    get Results() {
      return pb_1__namespace.Message.getRepeatedWrapperField(
        this,
    ...
    toObject() {
      ...
      if (this.Results != null) {
        data.Results = this.Results.map((item) => item.toObject());
      }
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new QueueMessagesBatchResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.QueueMessagesBatchResponse = QueueMessagesBatchResponse;
  class QueueMessageAttributes extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if ("MD5OfBody" in data && data.MD5OfBody != void 0) {
          this.MD5OfBody = data.MD5OfBody;
        }
        if ("ReceiveCount" in data && data.ReceiveCount != void 0) {
          this.ReceiveCount = data.ReceiveCount;
        }
        if ("ReRouted" in data && data.ReRouted != void 0) {
          this.ReRouted = data.ReRouted;
        }
        if ("ReRoutedFromQueue" in data && data.ReRoutedFromQueue != void 0) {
          this.ReRoutedFromQueue = data.ReRoutedFromQueue;
        }
        if ("ExpirationAt" in data && data.ExpirationAt != void 0) {
          this.ExpirationAt = data.ExpirationAt;
        }
        if ("DelayedTo" in data && data.DelayedTo != void 0) {
    ...
    get ReRouted() {
      return pb_1__namespace.Message.getFieldWithDefault(this, 5, false);
    }
    set ReRouted(value) {
      pb_1__namespace.Message.setField(this, 5, value);
    }
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new QueueMessageAttributes();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.QueueMessageAttributes = QueueMessageAttributes;
  class QueueMessagePolicy extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
      if (!Array.isArray(data) && typeof data == "object") {
        if ("ExpirationSeconds" in data && data.ExpirationSeconds != void 0) {
          this.ExpirationSeconds = data.ExpirationSeconds;
        }
        if ("DelaySeconds" in data && data.DelaySeconds != void 0) {
          this.DelaySeconds = data.DelaySeconds;
        }
        if ("MaxReceiveCount" in data && data.MaxReceiveCount != void 0) {
          this.MaxReceiveCount = data.MaxReceiveCount;
        }
        if ("MaxReceiveQueue" in data && data.MaxReceiveQueue != void 0) {
    ...
    set MaxReceiveCount(value) {
      pb_1__namespace.Message.setField(this, 3, value);
    }
    get MaxReceiveQueue() {
      return pb_1__namespace.Message.getFieldWithDefault(this, 4, "");
    }
    set MaxReceiveQueue(value) {
      pb_1__namespace.Message.setField(this, 4, value);
    }
    static fromObject(data) {
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new QueueMessagePolicy();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.QueueMessagePolicy = QueueMessagePolicy;
  class SendQueueMessageResult extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if ("SentAt" in data && data.SentAt != void 0) {
        ...
        if ("IsError" in data && data.IsError != void 0) {
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new SendQueueMessageResult();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.SendQueueMessageResult = SendQueueMessageResult;
  class ReceiveQueueMessagesRequest extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if ("MaxNumberOfMessages" in data && data.MaxNumberOfMessages != void 0) {
          this.MaxNumberOfMessages = data.MaxNumberOfMessages;
        }
        if ("WaitTimeSeconds" in data && data.WaitTimeSeconds != void 0) {
          this.WaitTimeSeconds = data.WaitTimeSeconds;
        }
        if ("IsPeak" in data && data.IsPeak != void 0) {
    ...
    set MaxNumberOfMessages(value) {
      pb_1__namespace.Message.setField(this, 4, value);
    }
    get WaitTimeSeconds() {
      return pb_1__namespace.Message.getFieldWithDefault(this, 5, 0);
    }
    set WaitTimeSeconds(value) {
      pb_1__namespace.Message.setField(this, 5, value);
    }
    get IsPeak() {
      return pb_1__namespace.Message.getFieldWithDefault(this, 6, false);
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new ReceiveQueueMessagesRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.ReceiveQueueMessagesRequest = ReceiveQueueMessagesRequest;
  class ReceiveQueueMessagesResponse extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(
      ...
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if ("MessagesReceived" in data && data.MessagesReceived != void 0) {
          this.MessagesReceived = data.MessagesReceived;
        }
        if ("MessagesExpired" in data && data.MessagesExpired != void 0) {
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new ReceiveQueueMessagesResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.ReceiveQueueMessagesResponse = ReceiveQueueMessagesResponse;
  class AckAllQueueMessagesRequest extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new AckAllQueueMessagesRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.AckAllQueueMessagesRequest = AckAllQueueMessagesRequest;
  class AckAllQueueMessagesResponse extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if ("AffectedMessages" in data && data.AffectedMessages != void 0) {
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new AckAllQueueMessagesResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.AckAllQueueMessagesResponse = AckAllQueueMessagesResponse;
  class StreamQueueMessagesRequest extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if ("StreamRequestTypeData" in data && data.StreamRequestTypeData != void 0) {
          this.StreamRequestTypeData = data.StreamRequestTypeData;
        }
        if ("Channel" in data && data.Channel != void 0) {
          this.Channel = data.Channel;
        }
        if ("VisibilitySeconds" in data && data.VisibilitySeconds != void 0) {
          this.VisibilitySeconds = data.VisibilitySeconds;
        }
        if ("WaitTimeSeconds" in data && data.WaitTimeSeconds != void 0) {
          this.WaitTimeSeconds = data.WaitTimeSeconds;
        }
        if ("RefSequence" in data && data.RefSequence != void 0) {
          this.RefSequence = data.RefSequence;
        }
        if ("ModifiedMessage" in data && data.ModifiedMessage != void 0) {
    ...
    set StreamRequestTypeData(value) {
      pb_1__namespace.Message.setField(this, 3, value);
    }
    get Channel() {
      return pb_1__namespace.Message.getFieldWithDefault(this, 4, "");
    ...
    set RefSequence(value) {
      pb_1__namespace.Message.setField(this, 7, value);
    }
    get ModifiedMessage() {
      return pb_1__namespace.Message.getWrapperField(this, QueueMessage, 8);
    }
    set ModifiedMessage(value) {
      pb_1__namespace.Message.setWrapperField(this, 8, value);
    }
    ...
    serialize(w) {
      ...
      if (this.RequestID.length) writer.writeString(1, this.RequestID);
      if (this.ClientID.length) writer.writeString(2, this.ClientID);
      if (this.StreamRequestTypeData != 0 /* StreamRequestTypeUnknown */)
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new StreamQueueMessagesRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.StreamQueueMessagesRequest = StreamQueueMessagesRequest;
  class StreamQueueMessagesResponse extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    get Message() {
      return pb_1__namespace.Message.getWrapperField(this, QueueMessage, 3);
    }
    set Message(value) {
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new StreamQueueMessagesResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.StreamQueueMessagesResponse = StreamQueueMessagesResponse;
  class QueuesUpstreamRequest extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new QueuesUpstreamRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.QueuesUpstreamRequest = QueuesUpstreamRequest;
  class QueuesUpstreamResponse extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(
      ...
      if (!Array.isArray(data) && typeof data == "object") {
        if ("RefRequestID" in data && data.RefRequestID != void 0) {
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new QueuesUpstreamResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.QueuesUpstreamResponse = QueuesUpstreamResponse;
  class QueuesDownstreamRequest extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(
      ...
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if ("MaxItems" in data && data.MaxItems != void 0) {
          this.MaxItems = data.MaxItems;
        }
        if ("WaitTimeout" in data && data.WaitTimeout != void 0) {
          this.WaitTimeout = data.WaitTimeout;
        }
        if ("AutoAck" in data && data.AutoAck != void 0) {
          this.AutoAck = data.AutoAck;
        }
        if ("ReQueueChannel" in data && data.ReQueueChannel != void 0) {
          this.ReQueueChannel = data.ReQueueChannel;
        }
        if ("SequenceRange" in data && data.SequenceRange != void 0) {
          this.SequenceRange = data.SequenceRange;
        }
        if ("RefTransactionId" in data && data.RefTransactionId != void 0) {
      ...
      if (!this.Metadata) this.Metadata = /* @__PURE__ */ new Map();
    }
    get RequestID() {
      return pb_1__namespace.Message.getFieldWithDefault(this, 1, "");
    }
    ...
    get AutoAck() {
      return pb_1__namespace.Message.getFieldWithDefault(this, 7, false);
    }
    set AutoAck(value) {
      pb_1__namespace.Message.setField(this, 7, value);
    }
    ...
    serialize(w) {
      ...
      if (this.RequestID.length) writer.writeString(1, this.RequestID);
      if (this.ClientID.length) writer.writeString(2, this.ClientID);
      if (this.RequestTypeData != 0 /* PollRequestTypeUnknown */)
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new QueuesDownstreamRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.QueuesDownstreamRequest = QueuesDownstreamRequest;
  class QueuesDownstreamResponse extends pb_1__namespace.Message {
    #one_of_decls = [];
    constructor(data) {
      super();
      pb_1__namespace.Message.initialize(
      ...
      if (!Array.isArray(data) && typeof data == "object") {
        if ("TransactionId" in data && data.TransactionId != void 0) {
        ...
        if ("ActiveOffsets" in data && data.ActiveOffsets != void 0) {
        ...
        if ("TransactionComplete" in data && data.TransactionComplete != void 0) {
    ...
    get Messages() {
      return pb_1__namespace.Message.getRepeatedWrapperField(this, QueueMessage, 4);
    }
    set Messages(value) {
    ...
    set TransactionComplete(value) {
      pb_1__namespace.Message.setField(this, 8, value);
    }
    get Metadata() {
      return pb_1__namespace.Message.getField(this, 9);
    }
    set Metadata(value) {
      pb_1__namespace.Message.setField(this, 9, value);
    }
    ...
    static deserialize(bytes) {
      const reader = bytes instanceof pb_1__namespace.BinaryReader ? bytes : new pb_1__namespace.BinaryReader(bytes), message = new QueuesDownstreamResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
  ...
  kubemq2.QueuesDownstreamResponse = QueuesDownstreamResponse;
  class UnimplementedkubemqService {
    static definition = {
      SendEvent: {
        ...
        requestDeserialize: (bytes) => Event.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message) => Buffer.from(message.serialize()),
        responseDeserialize: (bytes) => Result.deserialize(new Uint8Array(bytes))
      },
      SendEventsStream: {
      ...
      SubscribeToEvents: {
        ...
        responseStream: true,
        requestSerialize: (message) => Buffer.from(message.serialize()),
        requestDeserialize: (bytes) => Subscribe.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message) => Buffer.from(message.serialize()),
        responseDeserialize: (bytes) => EventReceive.deserialize(new Uint8Array(bytes))
      },
      SubscribeToRequests: {
        ...
        requestDeserialize: (bytes) => Subscribe.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message) => Buffer.from(message.serialize()),
        responseDeserialize: (bytes) => Request.deserialize(new Uint8Array(bytes))
      },
      SendRequest: {
      ...
      SendResponse: {
        ...
        responseStream: false,
        requestSerialize: (message) => Buffer.from(message.serialize()),
        requestDeserialize: (bytes) => Response.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message) => Buffer.from(message.serialize()),
      ...
      SendQueueMessage: {
        ...
        responseStream: false,
        requestSerialize: (message) => Buffer.from(message.serialize()),
        requestDeserialize: (bytes) => QueueMessage.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message) => Buffer.from(message.serialize()),
        responseDeserialize: (bytes) => SendQueueMessageResult.deserialize(new Uint8Array(bytes))
      },
      SendQueueMessagesBatch: {
        ...
        responseStream: false,
        requestSerialize: (message) => Buffer.from(message.serialize()),
        requestDeserialize: (bytes) => QueueMessagesBatchRequest.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message) => Buffer.from(message.serialize()),
        responseDeserialize: (bytes) => QueueMessagesBatchResponse.deserialize(new Uint8Array(bytes))
      },
      ReceiveQueueMessages: {
        ...
        responseStream: false,
        requestSerialize: (message) => Buffer.from(message.serialize()),
        requestDeserialize: (bytes) => ReceiveQueueMessagesRequest.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message) => Buffer.from(message.serialize()),
        responseDeserialize: (bytes) => ReceiveQueueMessagesResponse.deserialize(new Uint8Array(bytes))
      },
      StreamQueueMessage: {
        ...
        responseStream: true,
        requestSerialize: (message) => Buffer.from(message.serialize()),
        requestDeserialize: (bytes) => StreamQueueMessagesRequest.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message) => Buffer.from(message.serialize()),
        responseDeserialize: (bytes) => StreamQueueMessagesResponse.deserialize(new Uint8Array(bytes))
      },
      AckAllQueueMessages: {
        ...
        responseStream: false,
        requestSerialize: (message) => Buffer.from(message.serialize()),
        requestDeserialize: (bytes) => AckAllQueueMessagesRequest.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message) => Buffer.from(message.serialize()),
        responseDeserialize: (bytes) => AckAllQueueMessagesResponse.deserialize(new Uint8Array(bytes))
      },
      Ping: {
        ...
        responseSerialize: (message) => Buffer.from(message.serialize()),
        responseDeserialize: (bytes) => PingResult.deserialize(new Uint8Array(bytes))
      },
      QueuesDownstream: {
        ...
        responseStream: true,
        requestSerialize: (message) => Buffer.from(message.serialize()),
        requestDeserialize: (bytes) => QueuesDownstreamRequest.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message) => Buffer.from(message.serialize()),
        responseDeserialize: (bytes) => QueuesDownstreamResponse.deserialize(new Uint8Array(bytes))
      },
      QueuesUpstream: {
        ...
        responseStream: true,
        requestSerialize: (message) => Buffer.from(message.serialize()),
        requestDeserialize: (bytes) => QueuesUpstreamRequest.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message) => Buffer.from(message.serialize()),
        responseDeserialize: (bytes) => QueuesUpstreamResponse.deserialize(new Uint8Array(bytes))
      }
    };
  }
  kubemq2.UnimplementedkubemqService = UnimplementedkubemqService;
  class kubemqClient extends grpc__namespace.makeGenericClientConstructor(
...
var DEFAULT_KEEPALIVE = Object.freeze({
  timeMs: 1e4,
  timeoutMs: 5e3,
  permitWithoutCalls: true
});
var DEFAULT_RECONNECTION_POLICY = Object.freeze({
  maxAttempts: -1,
  initialDelayMs: 500,
  maxDelayMs: 3e4,
  multiplier: 2,
...
var DEFAULT_MAX_MESSAGE_SIZE = 104857600;
var DEFAULT_RECONNECT_BUFFER_SIZE = 8388608;
var DEFAULT_SEND_TIMEOUT_MS = 5e3;
var DEFAULT_SUBSCRIBE_TIMEOUT_MS = 1e4;
var DEFAULT_RPC_TIMEOUT_MS = 1e4;
var DEFAULT_QUEUE_RECEIVE_TIMEOUT_MS = 1e4;
var DEFAULT_QUEUE_POLL_TIMEOUT_MS = 3e4;
var DEFAULT_MAX_CONCURRENT_RETRIES = 10;
var SafeEventEmitter = class extends events.EventEmitter {
  #logger;
  setLogger(logger) {
    this.#logger = logger;
  }
...
// src/internal/transport/connection-state-machine.ts
var ConnectionStateMachine = class {
  ...
  transitionTo(newState, meta) {
    ...
    queueMicrotask(() => {
      ...
      switch (newState) {
        case "READY" /* READY */:
          if (oldState === "CONNECTING" /* CONNECTING */) {
            this.emitter.emit("connected");
          } else if (oldState === "RECONNECTING" /* RECONNECTING */) {
            this.emitter.emit("reconnected");
          }
          break;
        case "RECONNECTING" /* RECONNECTING */:
          if (oldState !== "RECONNECTING" /* RECONNECTING */) {
            this.emitter.emit("disconnected");
          }
          this.emitter.emit("reconnecting", meta?.attempt ?? 0);
          break;
        case "CLOSED" /* CLOSED */:
          if (meta?.discardedCount !== void 0 && meta.discardedCount > 0) {
...
// src/internal/transport/reconnection-manager.ts
var ReconnectionManager = class {
  ...
  attempt = 0;
  startTime = 0;
  constructor(policy, stateMachine, logger) {
  ...
  async reconnect(connectFn) {
    ...
    while (!this.isExhausted() && !this.abortController.signal.aborted) {
      ...
      this.stateMachine.transitionTo("RECONNECTING" /* RECONNECTING */, {
        attempt: this.attempt
      });
      ...
      try {
        ...
        this.reset();
        this.stateMachine.transitionTo("READY" /* READY */);
        return;
      } catch (err) {
...
// src/internal/transport/message-buffer.ts
var MessageBuffer = class {
  ...
  currentSizeBytes = 0;
  drainWaiters = [];
  constructor(maxSizeBytes, mode, logger) {
...
// src/internal/transport/in-flight-tracker.ts
...
// src/internal/transport/subscription-tracker.ts
...
function createConsoleLogger(level) {
  ...
  function emit(severity, consoleFn, msg, fields) {
    if (LOG_LEVEL_PRIORITY[severity] < threshold) {
      return;
    }
    if (fields !== void 0 && Object.keys(fields).length > 0) {
...
function resolveCredentialProvider(credentials2) {
  if (!credentials2) return void 0;
  if (typeof credentials2 === "string") {
    return new StaticTokenProvider(credentials2);
  }
  return credentials2;
}

// src/auth/token-cache.ts
var PROACTIVE_REFRESH_MARGIN_MS = 3e4;
var TokenCache = class {
  ...
  #classifyProviderError(err) {
    ...
    const isTransient = err.isTransient === true || error.message.includes("ECONNREFUSED") || error.message.includes("ETIMEDOUT") || error.message.includes("ENOTFOUND") || error.message.includes("network") || error.message.includes("unavailable");
    if (isTransient) {
...
async function resolvePemOrPath(input) {
  ...
  return promises.readFile(input);
}
var LOCALHOST_PATTERNS = /* @__PURE__ */ new Set(["localhost", "127.0.0.1", "::1", "[::1]"]);
...
function resolveTlsEnabled(tls, address) {
  if (typeof tls === "boolean") return tls;
  if (typeof tls === "object" && tls.enabled !== void 0) return tls.enabled;
  return !isLocalhostAddress(address);
}
function normalizeTlsOptions(tls, address) {
  const enabled = resolveTlsEnabled(tls, address);
  if (typeof tls === "boolean" || tls === void 0) {
    return { enabled };
  }
  return { ...tls, enabled };
}
var ALLOWED_TLS_VERSIONS = /* @__PURE__ */ new Set(["TLSv1.2", "TLSv1.3"]);
function validateMinTlsVersion(minVersion) {
...
async function validateCertificates(opts, logger) {
...
async function resolveSslParts(opts, logger) {
  let rootCerts = null;
  let clientCert = null;
  let clientKey = null;
  if (opts.caCert) {
...
async function buildFreshSslParts(source) {
...
var AUTH_METADATA_KEY = "authorization";
async function fetchTokenForMetadata(tokenCache, logger) {
  try {
...
function emitSecurityWarnings(opts, isLocalhost2, logger) {
  if (opts.insecureSkipVerify) {
  ...
  if (!opts.tlsEnabled && !isLocalhost2) {
...
// src/internal/transport/grpc-transport.ts
function buildChannelOptions(opts) {
  const keepalive = opts.keepalive ?? DEFAULT_KEEPALIVE;
  const reconnect = opts.reconnect ?? DEFAULT_RECONNECTION_POLICY;
  const tlsOpts = typeof opts.tls === "object" ? opts.tls : void 0;
  const channelOptions = {
    "grpc.max_receive_message_length": opts.maxReceiveMessageSize ?? 104857600,
    "grpc.max_send_message_length": opts.maxSendMessageSize ?? 104857600,
    ...
    "grpc.dns_min_time_between_resolutions_ms": 1e3,
...
var GrpcTransport = class {
  ...
  constructor(options) {
    ...
    this.messageBuffer = new MessageBuffer(
      options.reconnectBufferSize ?? 8388608,
  ...
  async connect() {
    ...
    this.stateMachine.transitionTo("CONNECTING" /* CONNECTING */);
    const sslParts = await this.resolveSslCredentials();
    let channelCreds;
    if (this.resolvedTls.enabled && sslParts) {
      channelCreds = grpc__namespace.credentials.createSsl(
        sslParts.rootCerts,
        sslParts.clientKey,
        sslParts.clientCert
      );
    } else {
      channelCreds = grpc__namespace.credentials.createInsecure();
    }
    let finalCreds = channelCreds;
    if (this.tokenCache && this.resolvedTls.enabled) {
      const tokenCache = this.tokenCache;
      const logger = this.logger;
      const callCreds = grpc__namespace.credentials.createFromMetadataGenerator((_params, callback) => {
        fetchTokenForMetadata(tokenCache, logger).then((token) => {
          const md = new grpc__namespace.Metadata();
          if (token) {
      ...
      finalCreds = grpc__namespace.credentials.combineChannelCredentials(channelCreds, callCreds);
  ...
  async close(timeoutMs) {
    ...
    if (this.stateMachine.state === "CLOSED" /* CLOSED */) {
      return;
    }
    this._closing = true;
    if (this.stateMachine.state === "RECONNECTING" /* RECONNECTING */) {
      this.reconnectionManager.cancel();
      const discarded = this.messageBuffer.discard();
      this.stateMachine.transitionTo("CLOSED" /* CLOSED */, { discardedCount: discarded });
      return;
    }
    try {
      await this.messageBuffer.flush(async (msg) => {
        msg.resolve(void 0);
      });
    } catch (err) {
    ...
    this.stateMachine.transitionTo("CLOSED" /* CLOSED */);
  }
  ensureNotClosed(operation) {
    if (this._closing || this.stateMachine.state === "CLOSED" /* CLOSED */) {
  ...
  duplexStream(method, options) {
    ...
    return this.wrapDuplexStream(stream);
  }
  getMetadata() {
  ...
  watchChannelState() {
    ...
    try {
      ...
      channel.watchConnectivityState(currentState, deadline, (_err) => {
  ...
  handleTransientFailure() {
    if (this._closing || this.stateMachine.state === "CLOSED" /* CLOSED */) return;
    ...
    this.reconnectionManager.reconnect(async () => {
      ...
      this.grpcClient = new kubemq.kubemqClient(this.address, finalCreds, this.channelOptions);
      await this.waitForChannelReady(5e3);
      this.watchChannelState();
    }).then(() => {
  ...
  buildGrpcMetadata() {
    if (this.tokenCache && !this.resolvedTls.enabled) {
      const metadata2 = new grpc__namespace.Metadata();
      for (const [key, value] of this.metadata) {
        metadata2.set(key, value);
      }
      const token = this.tokenCache.lastKnownToken;
      if (token) {
        metadata2.set(AUTH_METADATA_KEY, token);
      }
      return metadata2;
    }
  ...
  toRawTransportError(err) {
    const rawErr = new Error(err.details || err.message);
...
// src/internal/config-validator.ts
function validateClientOptions(opts) {
  ...
  if (opts.connectionTimeoutSeconds !== void 0 && opts.connectionTimeoutSeconds <= 0) {
    throw new ConfigurationError({
      code: ErrorCode.ConfigurationError,
  ...
  if (opts.maxReceiveMessageSize !== void 0 && opts.maxReceiveMessageSize <= 0) {
    throw new ConfigurationError({
      code: ErrorCode.ConfigurationError,
  ...
  if (opts.maxSendMessageSize !== void 0 && opts.maxSendMessageSize <= 0) {
    throw new ConfigurationError({
      code: ErrorCode.ConfigurationError,
  ...
  if (opts.reconnectBufferSize !== void 0 && opts.reconnectBufferSize < 0) {
    throw new ConfigurationError({
      code: ErrorCode.ConfigurationError,
...
function isValidAddress(address) {
  ...
  if (portStr === void 0) return false;
  const port = Number(portStr);
  if (isNaN(port) || port <= 0 || port > 65535) return false;
  const host = parts.slice(0, -1).join(":");
  return host.length > 0;
}
function validateTlsOptions(opts) {
...
function validateReconnectionPolicy(reconnect) {
  if (!reconnect) return;
...
function validateKeepaliveOptions(keepalive) {
  if (!keepalive) return;
...
function applyDefaults(options) {
  return {
    ...
    connectionTimeoutMs: options.connectionTimeoutSeconds != null ? options.connectionTimeoutSeconds * 1e3 : DEFAULT_CONNECTION_TIMEOUT_MS,
    ...
    tracerProvider: options.tracerProvider ?? void 0,
    meterProvider: options.meterProvider ?? void 0,
    ...
    defaultSendTimeoutMs: options.defaultSendTimeoutSeconds != null ? options.defaultSendTimeoutSeconds * 1e3 : DEFAULT_SEND_TIMEOUT_MS,
    defaultSubscribeTimeoutMs: options.defaultSubscribeTimeoutSeconds != null ? options.defaultSubscribeTimeoutSeconds * 1e3 : DEFAULT_SUBSCRIBE_TIMEOUT_MS,
    defaultRpcTimeoutMs: options.defaultRpcTimeoutSeconds != null ? options.defaultRpcTimeoutSeconds * 1e3 : DEFAULT_RPC_TIMEOUT_MS,
    defaultQueueReceiveTimeoutMs: options.defaultQueueReceiveTimeoutSeconds != null ? options.defaultQueueReceiveTimeoutSeconds * 1e3 : DEFAULT_QUEUE_RECEIVE_TIMEOUT_MS,
    defaultQueuePollTimeoutMs: options.defaultQueuePollTimeoutSeconds != null ? options.defaultQueuePollTimeoutSeconds * 1e3 : DEFAULT_QUEUE_POLL_TIMEOUT_MS
  };
}
function resolveTlsDefault(options) {
  if (options.tls !== void 0) return options.tls;
...
function toTagsMap(tags) {
  if (!tags) return /* @__PURE__ */ new Map();
...
function bodyBytes(body) {
  if (body === void 0 || body === null) return new Uint8Array(0);
  if (typeof body === "string") return normalizeBody(body);
  if (body instanceof Uint8Array) return body;
  if (Buffer.isBuffer(body)) return normalizeBody(body);
  return new Uint8Array(0);
}
function toProtoEvent(msg, clientId, store) {
  return new kubemq.Event({
    EventID: msg.id ?? crypto.randomUUID(),
    ClientID: msg.clientId ?? clientId,
    Channel: msg.channel,
    Metadata: msg.metadata ?? "",
    Body: msg.body !== void 0 ? bodyBytes(msg.body) : new Uint8Array(0),
    Store: store,
    Tags: toTagsMap(msg.tags)
  });
}
function toProtoSubscribeEvents(channel, group, clientId) {
...
function toProtoSubscribeEventsStore(sub, clientId) {
  return new kubemq.Subscribe({
    SubscribeTypeData: kubemq.Subscribe.SubscribeType.EventsStore,
    ClientID: clientId,
    Channel: sub.channel,
    Group: sub.group ?? "",
    EventsStoreTypeData: sub.startFrom,
    EventsStoreTypeValue: sub.startValue ?? 0
  });
}
function toProtoSubscribeCommands(channel, group, clientId) {
  return new kubemq.Subscribe({
...
function toProtoSubscribeQueries(channel, group, clientId) {
  return new kubemq.Subscribe({
...
function toProtoRequest(msg, clientId, type) {
  const req = new kubemq.Request({
    RequestID: msg.id ?? crypto.randomUUID(),
    RequestTypeData: type === "Command" ? kubemq.Request.RequestType.Command : kubemq.Request.RequestType.Query,
    ClientID: msg.clientId ?? clientId,
    Channel: msg.channel,
    Metadata: msg.metadata ?? "",
    Body: msg.body !== void 0 ? bodyBytes(msg.body) : new Uint8Array(0),
    Timeout: msg.timeoutInSeconds * 1e3,
    Tags: toTagsMap(msg.tags)
  });
  if (type === "Query") {
    const queryMsg = msg;
  ...
  const msgRecord = msg;
  if (msgRecord.span) req.Span = msgRecord.span;
  return req;
}
function toProtoResponse(resp, clientId) {
  ...
  const queryResp = resp;
  if (queryResp.metadata) pbResp.Metadata = queryResp.metadata;
  if (queryResp.body) pbResp.Body = queryResp.body;
  const respRecord = resp;
  if (respRecord.span) pbResp.Span = respRecord.span;
  return pbResp;
}
function toProtoQueueMessage(msg, clientId) {
...
function toProtoReceiveQueueRequest(req, clientId) {
...
function toProtoBatchRequest(messages) {
  return new kubemq.QueueMessagesBatchRequest({
    BatchID: crypto.randomUUID(),
    Messages: messages
  });
}
function fromProtoPingResult(result) {
  return {
    host: result.Host,
...
function fromProtoResult(result, operation) {
  if (!result.Sent) {
...
function fromProtoEventStoreResult(result) {
  return {
    id: result.EventID,
    sent: result.Sent,
    error: result.Error || ""
...
function fromProtoReceivedEvent(data) {
  return {
    id: data.EventID,
    channel: data.Channel,
    timestamp: new Date(Number(data.Timestamp) / 1e6),
    body: data.Body instanceof Uint8Array ? data.Body : new Uint8Array(0),
    metadata: data.Metadata,
    tags: fromTagsMap(data.Tags)
  };
}
function fromProtoReceivedEventStore(data) {
  return {
    id: data.EventID,
    channel: data.Channel,
    timestamp: new Date(Number(data.Timestamp) / 1e6),
...
function fromProtoReceivedCommand(data) {
  return {
    id: data.RequestID,
    channel: data.Channel,
...
function fromProtoReceivedQuery(data) {
  return {
    id: data.RequestID,
    channel: data.Channel,
    fromClientId: data.ClientID,
...
function fromProtoCommandResponse(data) {
  return {
    id: data.RequestID,
    replyChannel: data.ReplyChannel,
    clientId: data.ClientID || void 0,
    executed: data.Executed,
    error: data.Error || void 0,
    metadata: data.Metadata || void 0,
    body: data.Body instanceof Uint8Array && data.Body.length > 0 ? data.Body : void 0,
    tags: fromTagsMap(data.Tags),
    timestamp: data.Timestamp ? new Date(Number(data.Timestamp)) : void 0
  };
}
function fromProtoQueryResponse(data) {
  return {
    id: data.RequestID,
    replyChannel: data.ReplyChannel,
    clientId: data.ClientID || void 0,
...
function fromProtoBatchResponse(response) {
  const results = (response.Results || []).map((r, index) => ({
    index,
    messageId: r.IsError ? void 0 : r.MessageID || void 0,
    error: r.IsError ? new KubeMQError({
      code: ErrorCode.Fatal,
...
function fromProtoReceivedQueueMessage(msg) {
  ...
  return {
    ...
    timestamp: attrs ? new Date(Number(attrs.Timestamp) / 1e6) : /* @__PURE__ */ new Date(),
    sequence: attrs ? Number(attrs.Sequence) : 0,
    receiveCount: attrs ? attrs.ReceiveCount : 0,
    isReRouted: attrs ? attrs.ReRouted : false,
    reRouteFromQueue: attrs?.ReRoutedFromQueue || void 0,
    expiredAt: attrs?.ExpirationAt ? new Date(Number(attrs.ExpirationAt) / 1e6) : void 0,
    delayedTo: attrs?.DelayedTo ? new Date(Number(attrs.DelayedTo) / 1e6) : void 0
  };
}
function fromProtoReceiveQueueResponse(response, operation) {
  if (response.IsError) {
    throw new KubeMQError({
      code: ErrorCode.Fatal,
...
function toProtoQueuesUpstreamRequest(msgs, clientId) {
  return new kubemq.QueuesUpstreamRequest({
    RequestID: crypto.randomUUID(),
    Messages: msgs.map((m) => toProtoQueueMessage(m, clientId))
  });
}
function fromProtoQueuesUpstreamResponse(response, _operation) {
  return {
    requestId: response.RefRequestID,
    results: (response.Results || []).map((r) => ({
      messageId: r.MessageID,
      sentAt: new Date(Number(r.SentAt) / 1e6),
      expirationAt: r.ExpirationAt ? new Date(Number(r.ExpirationAt) / 1e6) : void 0,
      delayedTo: r.DelayedTo ? new Date(Number(r.DelayedTo) / 1e6) : void 0
    })),
    isError: response.IsError,
    error: response.Error || void 0
  };
}
function toProtoQueuesDownstreamRequest(opts, clientId) {
  const req = new kubemq.QueuesDownstreamRequest({
    RequestID: crypto.randomUUID(),
    ClientID: clientId,
    Channel: opts.channel,
    MaxItems: opts.maxMessages ?? 1,
    WaitTimeout: (opts.waitTimeoutSeconds ?? 5) * 1e3,
...
// src/internal/transport/subscription-handle.ts
var GrpcSubscriptionHandle = class {
  _isActive = true;
  _stream;
  logger;
  operationName;
  constructor(stream, logger, operationName) {
    this._stream = stream;
    this.logger = logger;
  ...
  attachLifecycleListeners(stream) {
    stream.onEnd(() => {
      this._isActive = false;
    });
    stream.onError(() => {
...
// src/internal/middleware/error-mapper.ts
var Status = {
  OK: 0,
  CANCELLED: 1,
  UNKNOWN: 2,
...
var SUGGESTIONS = {
  ...
  [ErrorCode.ValidationFailed]: "Check the request parameters \u2014 channel name may be empty or body missing.",
  ...
  [ErrorCode.PermissionDenied]: "You do not have permission for this operation. Check your credentials and ACLs.",
  ...
  [ErrorCode.ConfigurationError]: "Check your client configuration \u2014 TLS certificates or connection settings may be invalid.",
  [ErrorCode.ConnectionNotReady]: "Connection is not ready yet. Wait for the client to connect or check server availability.",
  [ErrorCode.RetryExhausted]: "All retry attempts have been exhausted. Check server health."
};
function mapGrpcError(err, ctx) {
  const baseOpts = {
...
// src/internal/concurrency/semaphore.ts
...
// src/internal/concurrency/callback-dispatcher.ts
var CallbackDispatcher = class {
  ...
  constructor(opts) {
    ...
    this.maxQueueDepth = opts.maxQueueDepth ?? 1e3;
...
// src/internal/streaming/base-streaming-sender.ts
var GRPC_CANCELLED = 1;
var GRPC_PERMISSION_DENIED = 7;
var GRPC_UNAUTHENTICATED = 16;
var BaseStreamingSender = class _BaseStreamingSender {
  logger;
  clientId;
  maxQueueSize;
  closeTimeoutMs;
  ...
  _transportOn = null;
  _transportOff = null;
  _transportDuplexStream = null;
  constructor(opts) {
    this.logger = opts.logger;
    this.clientId = opts.clientId;
    this.maxQueueSize = opts.maxQueueSize;
    this.closeTimeoutMs = opts.closeTimeoutMs ?? 5e3;
  }
  /**
  ...
  _openStream() {
    ...
    try {
      this.stream = this._transportDuplexStream(this.grpcMethod());
    } catch {
  ...
  _drain() {
    ...
    while (this.queue.length > 0) {
      ...
      written++;
      if (written >= _BaseStreamingSender.DRAIN_BATCH_SIZE && this.queue.length > 0) {
        this._scheduleDrainDeferred();
        return;
      }
    }
  ...
  _cleanupItemSignal(item) {
    if (item.signal && item.abortHandler) {
      item.signal.removeEventListener("abort", item.abortHandler);
      item.abortHandler = void 0;
    }
  }
};

// src/internal/streaming/async-event-sender.ts
var AsyncEventSender = class extends BaseStreamingSender {
  grpcMethod() {
    return "SendEventsStream";
  }
  extractRequestKey(request) {
    if (!request.Store) return null;
    if (!request.EventID) request.EventID = crypto.randomUUID();
    return request.EventID;
  }
  extractResponseKey(response) {
...
// src/internal/streaming/async-upstream-sender.ts
var AsyncUpstreamSender = class extends BaseStreamingSender {
  sendTimeoutMs;
  constructor(opts) {
    super(opts);
    this.sendTimeoutMs = opts.sendTimeoutMs ?? 2e3;
  }
  grpcMethod() {
...
// src/internal/runtime-check.ts
var MIN_NODE_MAJOR = 20;
var MIN_NODE_MINOR = 11;
function assertNodeVersion() {
  ...
  if (major < MIN_NODE_MAJOR || major === MIN_NODE_MAJOR && minor < MIN_NODE_MINOR) {
    throw new Error(
      `kubemq-js requires Node.js >= ${String(MIN_NODE_MAJOR)}.${String(MIN_NODE_MINOR)}.0. Detected ${process.version}. See COMPATIBILITY.md for supported versions.`
    );
  }
}

// src/internal/middleware/retry.ts
var IDEMPOTENT_OPERATIONS = /* @__PURE__ */ new Set([
  "events",
  "eventsStore",
  "subscribe"
]);
function createRetryThrottle(maxConcurrent) {
  let active = 0;
  return {
    tryAcquire() {
...
function resolveSignal(defaultTimeoutMs, opts) {
...
function resolveSignalOptional(opts) {
  if (opts?.signal && opts.timeout != null) {
    return AbortSignal.any([opts.signal, AbortSignal.timeout(opts.timeout)]);
  }
  if (opts?.signal) return opts.signal;
...
function resolveDeadline(defaultTimeoutMs, opts) {
  const timeoutMs = opts?.timeout ?? defaultTimeoutMs;
  return new Date(Date.now() + (timeoutMs > 0 ? timeoutMs : 3e4));
}
...
async function withRetry(fn, policy, ctx, logger, throttle, parentSignal, hooks) {
  ...
  for (let attempt = 0; attempt <= policy.maxRetries; attempt++) {
    try {
      ...
      if (lastError instanceof KubeMQTimeoutError && !IDEMPOTENT_OPERATIONS.has(ctx.operationType)) {
        throw new KubeMQTimeoutError({
          message: lastError.message,
          operation: lastError.operation,
          channel: lastError.channel,
          cause: lastError.cause instanceof Error ? lastError.cause : void 0,
...
// src/internal/telemetry/attributes.ts
var MESSAGING_SYSTEM = "messaging.system";
var MESSAGING_SYSTEM_VALUE = "kubemq";
var MESSAGING_OPERATION_NAME = "messaging.operation.name";
var MESSAGING_OPERATION_TYPE = "messaging.operation.type";
var MESSAGING_DESTINATION_NAME = "messaging.destination.name";
var MESSAGING_MESSAGE_ID = "messaging.message.id";
var MESSAGING_CLIENT_ID = "messaging.client.id";
var MESSAGING_CONSUMER_GROUP_NAME = "messaging.consumer.group.name";
var MESSAGING_BATCH_MESSAGE_COUNT = "messaging.batch.message_count";
var MESSAGING_MESSAGE_BODY_SIZE = "messaging.message.body.size";
var SERVER_ADDRESS = "server.address";
var SERVER_PORT = "server.port";
var ERROR_TYPE = "error.type";
var METRIC_OPERATION_DURATION = "messaging.client.operation.duration";
var METRIC_SENT_MESSAGES = "messaging.client.sent.messages";
var METRIC_CONSUMED_MESSAGES = "messaging.client.consumed.messages";
var METRIC_CONNECTION_COUNT = "messaging.client.connection.count";
var METRIC_RECONNECTIONS = "messaging.client.reconnections";
var METRIC_RETRY_ATTEMPTS = "kubemq.client.retry.attempts";
var METRIC_RETRY_EXHAUSTED = "kubemq.client.retry.exhausted";
var DURATION_HISTOGRAM_BOUNDARIES = [
  1e-3,
  25e-4,
  5e-3,
  0.01,
...
var SPAN_EVENT_RETRY = "retry";
var INSTRUMENTATION_SCOPE_NAME = "kubemq-js";

// src/internal/middleware/telemetry.ts
var TelemetryMiddleware = class {
  constructor(logger, sdkVersion) {
    this.logger = logger;
    this.sdkVersion = sdkVersion;
  }
  tracer;
  api;
  async lazyLoadApi(tracerProvider) {
    if (this.api) return;
    try {
  ...
  get isEnabled() {
    return this.tracer !== void 0;
  }
  startSpan(config, parentContext) {
    if (!this.tracer || !this.api) return void 0;
  ...
  addRetryEvent(span, attempt, delaySeconds, errorType) {
...
// src/internal/middleware/metrics.ts
var MetricsMiddleware = class {
  constructor(logger, sdkVersion, cardinalityConfig = {
    maxChannelNames: 100,
    channelAllowlist: /* @__PURE__ */ new Set()
  }) {
    this.logger = logger;
    this.sdkVersion = sdkVersion;
  ...
  cardinalityWarned = false;
  async lazyLoadApi(meterProvider) {
    if (this.api) return;
    try {
      this.api = await import('@opentelemetry/api');
...
// src/client.ts
function validateChannelName(channel, operation) {
...
var KubeMQClient = class _KubeMQClient {
  #options;
  #resolved;
  #transport;
  #activeDispatchers = /* @__PURE__ */ new Set();
  #retryPolicy;
  #retryThrottle;
  #telemetry;
  #metrics;
  #eventSenderPromise = null;
  #upstreamSenderPromise = null;
  #closing = false;
  #closePromise = null;
  constructor(options, resolved, transport) {
  ...
  static _createForTesting(options, resolved, transport) {
    return new _KubeMQClient(options, resolved, transport);
  }
  ...
  static async create(options) {
    ...
    const client = new _KubeMQClient(options, resolved, transport);
    ...
    transport.on("stateChange", (state) => {
      if (state === "READY" /* READY */) {
        ...
        client.#metrics.recordConnectionChange(-1);
      } else if (state === "RECONNECTING" /* RECONNECTING */) {
  ...
  async sendEvent(msg, _opts) {
    ...
    try {
      ...
      this.#telemetry.endSpan(span, err instanceof KubeMQError ? err : void 0);
      throw err;
    } finally {
      this.#metrics.recordOperationDuration((performance.now() - t0) / 1e3, {
  ...
  subscribeToEvents(sub, opts) {
    ...
    const createAndAttachStream = () => {
      ...
      const s = this.#transport.serverStream(
        "SubscribeToEvents",
        pbSubscribe
      );
      currentStream = s;
   ...
   */
  subscribeToEventsStore(sub, opts) {
   ...
   */
  async sendQueueMessage(msg, opts) {
    ...
    try {
      ...
      const result = parsed.results[0] ?? { messageId: msg.id ?? "", sentAt: /* @__PURE__ */ new Date() };
   ...
   */
  async sendQueueMessagesBatch(msgs, opts) {
    ...
    try {
      const result = await withRetry(
        async (sig) => {
          const response = await this.#transport.unaryCall("SendQueueMessagesBatch", batchReq, { signal: sig });
   ...
   */
  async receiveQueueMessages(req, opts) {
    ...
    try {
      rawMessages = await withRetry(
        async (sig) => {
          const response = await this.#transport.unaryCall("ReceiveQueueMessages", pbReq, { signal: sig });
  ...
  streamQueueMessages(opts) {
      ...
      stream.onData((data) => {
        ...
        const messages = rawMessages.map((msg) => {
          ...
          return {
            ...
            sequence: attrs ? Number(attrs.Sequence) : 0,
            receiveCount: attrs ? attrs.ReceiveCount : 0,
            md5OfBody: attrs?.MD5OfBody || void 0,
    ...
    tracker.register({
      ...
      resubscribe: () => {
        ...
        activeTransactionId = void 0;
        stream = this.#transport.duplexStream("QueuesDownstream");
        attachStreamHandlers();
        const rePoll = toProtoQueuesDownstreamRequest(opts, clientId);
        stream.write(rePoll);
      }
    ...
    return {
      ...
      reQueueRange(channel, sequences) {
   ...
   * @see {@link QueuePollRequest}
   */
  async peekQueueMessages(req, opts) {
  ...
  async sendCommand(msg, opts) {
    ...
    try {
      const result = await withRetry(
        async (sig) => {
          const response = await this.#transport.unaryCall(
            "SendRequest",
            pbReq,
            { signal: signal ? sig : void 0, deadline }
          );
      ...
      const mapped = err instanceof KubeMQError ? err : this.#mapStreamError(err, "sendCommand", msg.channel);
  ...
  async sendQuery(msg, opts) {
    ...
    try {
      ...
      const mapped = err instanceof KubeMQError ? err : this.#mapStreamError(err, "sendQuery", msg.channel);
      this.#telemetry.endSpan(span, mapped);
      throw mapped;
    } finally {
      this.#metrics.recordOperationDuration((performance.now() - t0) / 1e3, {
   ...
   * @see {@link CommandResponse}
   */
  async sendCommandResponse(resp, opts) {
    ...
    try {
      await withRetry(
        async (sig) => {
          await this.#transport.unaryCall("SendResponse", pbResp, {
            signal: signal ? sig : void 0,
            deadline
          });
        },
        this.#retryPolicy,
   ...
   * @see {@link QueryResponse}
   */
  async sendQueryResponse(resp, opts) {
   ...
   */
  async sendCommandResponseDirect(resp, opts) {
   ...
   */
  async sendQueryResponseDirect(resp, opts) {
   ...
   */
  async createChannel(channelName, channelType) {
    ...
    await this.#transport.unaryCall(
      "SendRequest",
      pbReq,
   ...
   * @see {@link listChannels}
   */
  async deleteChannel(channelName, channelType) {
   ...
   */
  async listChannels(channelType, search) {
      ...
      async (sig) => {
        ...
        if (response.Error.includes("cluster snapshot not ready")) {
          throw new TransientError({
            ...
            isRetryable: true,
            suggestion: "Retry after a short delay; the cluster needs time to build its snapshot after startup"
          });
        }
  ...
  async #doClose(opts) {
    this.#closing = true;
    const callbackTimeoutMs = opts?.callbackTimeoutSeconds != null ? opts.callbackTimeoutSeconds * 1e3 : 3e4;
    ...
    await this.#transport.close(
      opts?.timeoutSeconds != null ? opts.timeoutSeconds * 1e3 : void 0
    );
  }
  /**
  ...
  async ping(opts) {
    ...
    try {
      return await withRetry(
        async (sig) => {
          const result = await this.#transport.unaryCall(
            "Ping",
            new kubemq.Empty(),
            { signal: sig }
          );
   ...
   * @see {@link purgeQueue}
   */
  async ackAllQueueMessages(channel, waitTimeSeconds = 1, opts) {
    ...
    try {
      ...
      await withRetry(
        async (sig) => {
          const response = await this.#transport.unaryCall("AckAllQueueMessages", pbReq, { signal: sig });
          if (response.IsError) {
            throw new KubeMQError({
              code: ErrorCode.Fatal,
  ...
  createQueueUpstream() {
    ...
    let stream = this.#transport.duplexStream("QueuesUpstream");
    let active = true;
    ...
    const attachHandlers = () => {
      stream.onData((data) => {
        ...
        if (p) {
          ...
          const resp = fromProtoQueuesUpstreamResponse(data);
    ...
    tracker.register({
      ...
      resubscribe: () => {
        ...
        pending.clear();
        stream = this.#transport.duplexStream("QueuesUpstream");
        attachHandlers();
      }
    });
    return {
  ...
  async *consumeQueue(opts) {
    ...
    try {
      ...
      handle.onMessages((messages) => {
        const txnId = String(messages[0]?._transactionId ?? "");
        const batch = {
          messages,
          transactionId: txnId,
          ackAll: () => {
  ...
  createEventStream() {
    ...
    let stream = this.#transport.duplexStream("SendEventsStream");
    let active = true;
    ...
    const recreateStream = () => {
      ...
      stream = transport.duplexStream("SendEventsStream");
      drainListenerAttached = false;
      streamReady = true;
      attachHandlers();
    };
    ...
    const selfHeal = async () => {
      ...
      try {
        let delay = 500;
        const maxDelay = 5e3;
        while (active && transport.state !== "READY" /* READY */) {
  ...
  #parseServerAddress() {
    ...
    if (colonIdx > 0) {
      ...
      return { host: addr.slice(0, colonIdx), port: Number.isFinite(port) ? port : 5e4 };
    }
    return { host: addr, port: 5e4 };
  }
  #startSpan(operationName, channel, spanKind, extra) {
    if (!this.#telemetry.isEnabled) return void 0;
  ...
  #retryHooks(operationName, channel) {
    return {
      onRetry: () => {
  ...
  #mapStreamError(err, operation, channel) {
    const rawErr = err;
...
// src/internal/validation/message-size.ts
function validateMessageSize(body, maxSendMessageSize, operation, channel) {
...
function createEventMessage(opts) {
...
function createQueueMessage(opts) {
  ...
  const msg = {
    ...
    metadata: opts.metadata ?? "",
    tags: opts.tags ?? {},
    policy: opts.policy ? Object.freeze({ ...opts.policy }) : void 0,
    id: opts.id ?? crypto.randomUUID(),
    clientId: opts.clientId
  };
  return Object.freeze(msg);
...
exports.ConnectionNotReadyError = ConnectionNotReadyError;
exports.ConnectionState = ConnectionState;
exports.DEFAULT_CONNECTION_TIMEOUT_MS = DEFAULT_CONNECTION_TIMEOUT_MS;
exports.DEFAULT_KEEPALIVE = DEFAULT_KEEPALIVE;
exports.DEFAULT_MAX_CONCURRENT_RETRIES = DEFAULT_MAX_CONCURRENT_RETRIES;
exports.DEFAULT_MAX_MESSAGE_SIZE = DEFAULT_MAX_MESSAGE_SIZE;
exports.DEFAULT_QUEUE_POLL_TIMEOUT_MS = DEFAULT_QUEUE_POLL_TIMEOUT_MS;
exports.DEFAULT_QUEUE_RECEIVE_TIMEOUT_MS = DEFAULT_QUEUE_RECEIVE_TIMEOUT_MS;
exports.DEFAULT_RECONNECTION_POLICY = DEFAULT_RECONNECTION_POLICY;
exports.DEFAULT_RECONNECT_BUFFER_SIZE = DEFAULT_RECONNECT_BUFFER_SIZE;
exports.DEFAULT_RETRY_POLICY = DEFAULT_RETRY_POLICY;
exports.DEFAULT_RPC_TIMEOUT_MS = DEFAULT_RPC_TIMEOUT_MS;
exports.DEFAULT_SEND_TIMEOUT_MS = DEFAULT_SEND_TIMEOUT_MS;
exports.DEFAULT_SUBSCRIBE_TIMEOUT_MS = DEFAULT_SUBSCRIBE_TIMEOUT_MS;
exports.ErrorCategory = ErrorCategory;
exports.ErrorCode = ErrorCode;
exports.EventStoreStartPosition = EventStoreStartPosition;
exports.FatalError = FatalError;
exports.HandlerError = HandlerError;
exports.KubeMQClient = KubeMQClient;
exports.KubeMQError = KubeMQError;
exports.KubeMQTimeoutError = KubeMQTimeoutError;
...
exports.StreamBrokenError = StreamBrokenError;
...
exports.createEventStoreMessage = createEventStoreMessage;
exports.createQuery = createQuery;
exports.createQueueMessage = createQueueMessage;
